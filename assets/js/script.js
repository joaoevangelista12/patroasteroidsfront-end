...
function toggleErrosEmail() {
  ...
  form.emailInvalidoErro().style.display = validarEmail(email)
    ? "none"
    : "block";
}
...
function togglePasswordErro() {
  form.passwordObrigatoria().style.display = form.password().value
    ? "none"
    : "block";
}
...
window.onload = function () {
  ...
  if (currentUser) {
    document.getElementById("profilePic").src =
      ...
      "https://ppgquimica.propg.ufabc.edu.br/wp-content/uploads/2016/05/sem-imagem-avatar.png";
      ...
      if (newProfilePic) {
        ...
        reader.onload = function () {
          ...
          msgSuccess.innerHTML =
            "<strong>Foto atualizada com sucesso!</strong>";
